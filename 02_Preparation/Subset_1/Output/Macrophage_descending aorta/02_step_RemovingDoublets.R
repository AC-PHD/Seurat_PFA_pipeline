...
# # import data ----
# read in 
Input_name <- c("Macrophage_desc") # the name will be used for the output file
...
Input_RDS <- readRDS("Macrophage_descending aorta.rds") # name / path to subgroup created in the step before
